...
export async function create(c: Context): Promise<TypedResponse> {
    ...
    return response_created(c, serviceResponse.data, "Successfully created new Shift!");
}
...
export async function getAll(c: Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully fetched all Shift!");
}
...
export async function getById(c: Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully fetched Shift by id!");
}
...
export async function update(c: Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully updated Shift!");
}
...
export async function deleteByIds(c: Context): Promise<TypedResponse> {
    ...
    return response_success(c, serviceResponse.data, "Successfully deleted Shift!");
}
