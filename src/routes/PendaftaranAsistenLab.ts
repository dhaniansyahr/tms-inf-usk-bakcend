...
PendaftaranAsistenLabRoutes.get("/", AuthMiddleware.checkJwt, AuthMiddleware.checkAccess("PENDAFTARAN_ASISTEN_LAB", "read"), PendaftaranAsistenLabController.getAll);

PendaftaranAsistenLabRoutes.get("/:id", AuthMiddleware.checkJwt, AuthMiddleware.checkAccess("PENDAFTARAN_ASISTEN_LAB", "read"), PendaftaranAsistenLabController.getById);
...
PendaftaranAsistenLabRoutes.delete("/", AuthMiddleware.checkJwt, AuthMiddleware.checkAccess("PENDAFTARAN_ASISTEN_LAB", "delete"), PendaftaranAsistenLabController.deleteByIds);
