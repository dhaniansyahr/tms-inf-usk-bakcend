...
export async function create(data: RuanganLaboratoriumDTO): Promise<ServiceResponse<CreateResponse>> {
        try {
...
export async function update(id: string, data: RuanganLaboratoriumDTO): Promise<ServiceResponse<UpdateResponse>> {
        try {
                let ruanganLaboratorium = await prisma.ruanganLaboratorium.findUnique({
                        where: {
                                id,
...
export async function assignKepalaLab(id: string, data: AssignKepalaLabDTO): Promise<ServiceResponse<AssignKepalaLabResponse>> {
        try {
